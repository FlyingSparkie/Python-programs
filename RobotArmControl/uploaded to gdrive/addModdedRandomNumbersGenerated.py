...
aButton = Button(None,text = "click", fg = "Blue")
aButton.pack()
getOperations()
rep=int(int(len(operQ)))
if (rep == 0):
    rep=1                           # stops out of limit error
...
picked=int(rep*random.random())
print("degress picked out", degQ[picked] ,"from ", picked, " out of ", rep)
picked=int(rep*random.random())
print("degress picked out", degQ[picked] ,"from ", picked, " out of ", rep)
picked=int(rep*random.random())
print("degress picked out", degQ[picked] ,"from ", picked, " out of ", rep)
